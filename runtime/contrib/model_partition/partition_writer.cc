...
JsonReadWrite::JsonReadWrite(std::string modelfile)
...
std::vector<int> JsonReadWrite::read_exectime(){
...
std::vector<std::vector<int>> JsonReadWrite::read_dag(){
...
void JsonReadWrite::add_partition_record(std::vector<int> partition_map, int k)
{
//   Json::Value rec;
//   rec["op_id"] = op_id;
//   rec["ts"] = time;
...
void JsonReadWrite::open_file(void)
{
...
void JsonReadWrite::write_to_file(void) { _writer->write(_root, &_json_file); }

void JsonReadWrite::write_and_close_file(void)
{
